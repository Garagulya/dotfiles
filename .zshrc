...
# Automatically configure fnm (Fast Node Manager) for Zsh,
# so it switches Node.js versions automatically when you change directories.
# The --use-on-cd flag makes fnm check for .node-version or .nvmrc files in the current directory
# and automatically use the specified Node.js version.
# This ensures the correct Node.js version is used based on the project.
